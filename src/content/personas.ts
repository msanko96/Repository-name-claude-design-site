...
const FREELANCER: Record<Lang, PersonaContent> = {
  ru: {
    ...
    price: {
      ...
      features: [
        "5 фильтров вакансий",
        "Мгновенные уведомления: Telegram",
        "Безлимит уведомлений и генераций",
        "Шаблоны откликов для быстрого написания",
        "AI-черновики cover letter",
        "AI-квалификация вакансий",
        "Только индивидуальный профиль",
        "Быстрая поддержка",
      ],
      cta: "Попробовать →",
    },
  ...
  en: {
    ...
    price: {
      ...
      features: [
        ...
        "Proposal templates for fast writing",
        "AI cover-letter drafts",
        "AI job qualification",
        "Individual profile only",
        "Fast support",
      ],
      cta: "Try it →",
    },
